...
export default function Projects() {
  ...
  // Calculate transform for desktop sticky scroll
  ...
  return (
    <>
      <section
        ref={targetRef}
        id="projects"
        className={`relative bg-background text-foreground scroll-mt-20 py-12 md:py-0 ${
          isMobile ? "h-auto" : "h-auto md:h-[180vh]"
        }`}
      >
        <div
          className={`relative flex h-auto items-center overflow-x-auto no-scrollbar ${
            isMobile ? "" : "md:sticky md:top-0 md:h-screen md:overflow-hidden"
          }`}
        >
          <motion.div
            style={{ x: isMobile ? "0%" : x }}
            className="flex flex-col md:flex-row gap-6 sm:gap-10 px-4 sm:px-8 md:px-20 items-stretch md:items-center w-full md:w-auto"
          >
            {/* Start Section: Banner */}
            <div className="flex flex-col justify-center w-full md:w-[85vw] md:max-w-[480px] shrink-0 space-y-3 sm:space-y-5 pr-0 md:pr-6">
              ...
              <div className="flex flex-col leading-none space-y-1">
                <span className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight uppercase bg-gradient-to-r from-cyan-600 via-teal-600 to-blue-600 dark:from-cyan-400 dark:via-teal-200 dark:to-blue-500 bg-clip-text text-transparent drop-shadow-sm dark:drop-shadow-[0_0_35px_rgba(34,211,238,0.3)]">
                  SELECTED
                </span>
                <span className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-normal italic font-serif lowercase text-slate-800 dark:text-slate-200 pb-1 sm:pb-2">
                  projects
                </span>
              </div>
            ...
            {projectsList.map((project: ProjectItem & { year?: string }, index: number) => (
              <div
                ...
                className="group relative flex flex-col justify-between w-full md:w-[580px] lg:w-[650px] min-h-[460px] md:h-[62vh] shrink-0 cursor-pointer rounded-3xl border border-border/60 bg-card/50 backdrop-blur-md overflow-hidden transition-all duration-300 hover:border-cyan-500/50 hover:shadow-2xl hover:shadow-cyan-500/10"
              >
                {/* Image Container */}
                {project.image && (
                  <div className="relative w-full h-[220px] sm:h-[55%] md:h-[60%] overflow-hidden bg-muted">
                    <Image
                      src={project.image}
            ...
            {/* End CTA Section */}
            <div className="group relative flex flex-col justify-between w-full md:w-[420px] lg:w-[480px] min-h-[360px] md:h-[62vh] shrink-0 rounded-3xl border border-cyan-500/30 bg-gradient-to-br from-card/80 via-card/40 to-cyan-950/20 backdrop-blur-xl p-6 sm:p-10 transition-all duration-300 hover:border-cyan-400 hover:shadow-[0_0_50px_rgba(34,211,238,0.15)] mr-0 md:mr-12">
