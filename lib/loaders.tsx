...
export const getDictionary = (locale: Locale): Promise<DictionaryType> => {
  const loader = dictionaries[locale] ?? dictionaries.en;
  return loader();
};

export const getContents = (locale: Locale): Promise<ContentLanguageType> => {
  const loader = contents[locale] ?? contents.en;
  return loader();
};

export const getSharedData = (): Promise<SharedDataType> =>
